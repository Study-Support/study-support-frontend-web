          ...
          <form class="col" @submit.prevent="submit">
            ...
            <BRow>
              ...
              <BCol role="group">
                ...
                <BFormInvalidFeedback>
                  <ValidationErrorMessage
                    :messages="validationErrorMessages.passwordConfirm"
                  />
                </BFormInvalidFeedback>
              </BCol>
            </BRow>
            <BRow>
              <BCol role="group">
                ...
                <BFormInput
                  ...
                  :state="
                    validationErrorMessages.full_name === undefined
                      ? null
                      : false
                  "
                  aria-describedby="input-live-help input-live-feedback"
            ...
            <BRow>
              <BCol role="group">
                ...
                <BFormInvalidFeedback>
                  <ValidationErrorMessage
                    :messages="validationErrorMessages.phone_number"
                  />
                </BFormInvalidFeedback>
              </BCol>
            </BRow>
            <BRow>
              ...
              <BCol>
                <select v-model="registerData.gender" class="form-select mt-2">
...
onFetchError(() => {
  ...
  if (statusCode.value === getConfig('constants.statusCodes.validation')) {
    ...
    isPasswordMatched.value =
      validationErrorMessages.passwordConfirm !== '' ? null : false
  }
  return false
})
const submit = () => {
