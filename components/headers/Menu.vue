<template>
  <div>
    <div class="menu">
      <div>
        <p><BIconChevronDown /> Trang cá nhân</p>
        <button
          class="i1"
          :class="`${route.path.substring(12, 15)}`"
        ...
        <button
          class="i2"
          :class="`${route.path.substring(12, 15)}`"
          @click="navigateTo('/my-account/evaluate')"
        >
        ...
        <button
          class="i8"
          :class="`${route.path.substring(12, 15)}`"
          @click="navigateTo('/my-account/mentor-infor')"
        >
          <BIconPersonVideo3 /> Thông tin làm mentor
        </button>
      </div>
      <div>
        <p><BIconChevronDown /> Nhóm của tôi</p>
        <button
          class="i3"
          :class="`${route.path.substring(19, 28)}`"
      ...
      <div>
        <p><BIconChevronDown /> Yêu cầu chờ duyệt</p>
        <button
          class="i5"
          :class="`${route.path.substring(19, 37)}`"
...
.i3.is-member,
.i4.is-mentor,
.i5.request-create-gro,
.i6.request-is-member,
.i7.request-is-mentor {
